...
class StatefulAmericanFoodPage extends StatefulWidget {
  const StatefulAmericanFoodPage({super.key});

  @override
  State<StatefulWidget> createState() {
    return AmericanFoodPage();
  }
}

class AmericanFoodPage extends State<StatefulAmericanFoodPage> {
  List<Image> images = [
